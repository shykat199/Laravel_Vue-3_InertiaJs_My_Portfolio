            ...
            "
              ...
              "
                ...
                <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                    <img
                        class="rounded-lg"
                        src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mzl8fHdvcmt8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
                        alt="Hero"
                    />
                </div>
            </div>
