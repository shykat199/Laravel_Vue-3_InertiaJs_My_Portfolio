            ...
            <ul class="flex flex-col lg:flex-row justify-evenly items-center">
                <li class="cursor-pointer capitalize m-4">
                    <button
                        ...
                        :class="[selectedSkill === 'all'? 'bg-accent' :'bg-light-tail-500 dark:bg-dark-navy-100',]">
                        All
                    </button>
                </li>
                <li class="cursor-pointer capitalize m-4" v-for="projectSkill in props.skills.data" :key="projectSkill.id">
                    <button
                        ...
                        class=" flex text-center px-4 py-2 hover:bg-accent text-white rounded-md"
                        :class="[selectedSkill === projectSkill.id ? 'bg-accent': 'bg-light-tail-500 dark:bg-dark-navy-100']">
                        {{ projectSkill.name }}
                    </button>
                </li>
            </ul>
