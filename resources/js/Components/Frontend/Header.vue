        ...
        >
            ...
            >
                <a href="#" class="flex items-center">
                    <img
                        src="https://seekvectorlogo.com/wp-content/uploads/2019/05/portfolio-plus-banking-software-vector-logo.png"
...
onMounted(() => {
    window.addEventListener("scroll", () => {
        return window.screenY > 50 ? setScrollBg(true) : setScrollBg(false)
    })
})
